...
const videoWorks=[{no:'01',title:'杜比全景声《失物招领》',image:'/assets/media/lost-and-found-poster.jpg',video:'/assets/media/lost-and-found.mp4',presentation:'/assets/media/lost-and-found-presentation.pptx'},{no:'02',title:'全景声《英雄联盟》',image:'/assets/media/league-of-legends-poster.jpg',video:'/assets/media/league-of-legends-web.mp4'}]
...
<footer className="contact-section shell" id="contact"><p className="section-kicker">CONTACT</p><h2>一起创造<br/>值得被听见的作品。</h2><a className="email" href="mailto:heliwen20@gmail.com">heliwen20@gmail.com <span>↗</span></a><div className="footer-line"><span>© 2026 LI WENHE</span><span>SHANGHAI / CHINA</span><a href="#work">返回顶部 ↑</a></div></footer>
<dialog ref={videoDialog} className="video-dialog" onClose={()=>setSelectedVideo(null)}><button onClick={()=>videoDialog.current?.close()}>×</button><video key={selectedVideo?.video} controls autoPlay playsInline preload="none" poster={selectedVideo?.image}><source src={selectedVideo?.video} type="video/mp4"/></video><p>{selectedVideo?.title}</p></dialog>
